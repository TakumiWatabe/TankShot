...
void ClosestPtPoint2Triangle(const Vector3& _point, const Triangle& _tri, Vector3 * _closest)
{
	...
	//_pointがP0_P1の辺領域の中にあるかどうかチェックしあれば
...
// 三角形と点の当たり判定
bool CheckPoint2Triangle(const Vector3& _point, const Triangle& _tri)
{
	...
	Vector3 v01 = _tri.P1 - _tri.P0;
	Vector3 v12 = _tri.P2 - _tri.P1;
	Vector3 v20 = _tri.P0 - _tri.P2;
	// 三角形の各頂点から点へのベクトルをそれぞれ計算
	Vector3 v0p = _point - _tri.P0;
	Vector3 v1p = _point - _tri.P1;
	Vector3 v2p = _point - _tri.P2;
